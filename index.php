...
<body>
    ...
    <?php
        ...
        <div class="container">
            ...
            <a href="index.php"><img src="Img/TwEEttaLk.jpg" width="200.8px" height="80px"></a>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navBar">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="#myCarousel">Cover</a></li>
                ...
                <form method="post">
                    <div class="col-md-6 col-xs-12 signInTab">
                        <center>
                            ...
                            <br><br>
                            <p style="font-size:16px;">New to TwEEttaLk? Sign Up Here.. <span class="glyphicon glyphicon-arrow-right"></span></p>
                        </center>
                    </div>
                </form>
            ...
            <div class="container-fluid aboutDiv" id="about">
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-10" style="padding-left:30px;">
                        ...
                        <p class="aboutInfo"><span class="glyphicon glyphicon-envelope"></span> <b>Mail Us:</b><br> <a href="TwEEttaLk@sample.com">TwEEttaLk@sample.com</a></p>

                        <p class="aboutInfo"><span class="glyphicon glyphicon-phone"></span> <b>Contact Us:</b><br> 09111111111</p>

                        <p class="aboutInfo"><i class="fa fa-facebook-square"></i> <b>Follow Us:</b><br> <a href="#">Facebook.com</a></p>
                        <br>
                        <p>&copy; TwEEttaLk 9999</p>
                    </div>
