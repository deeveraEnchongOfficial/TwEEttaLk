...
<head>
    ...
    <title>TwEEttaLk | Create Tweet</title>
            ...
            <div class="row">
                <div class="col-md-6 col-md-push-3 cusContainer" style="padding:0px;">
                    <div style="background-color:#FFFFFF;">
                        <a href="homepage.php"><img src="Img/TwEEttaLk.jpg " width="145px " height="60px " alt="TwEEttaLk" style="margin:10px 0px 10px 20px"></a>
                ...
                <div class="icon-bar">
                        ...
                        <a style="color:white; background-color: #000000;" href="newTweet.php"><i class="fa fa-twitter tabLogo "></i></a>
                ...
                <div id="recentTw" class="mainContainer" style="height:auto;">
                    ...
                    <?php
                        ...
                        ?>
                        <form method="post">
                            <textarea placeholder="What's Happening in TwEEttaLk?" name="txtNewTweet" rows="5" cols="90" required style="font-size:16px;padding:10px; width:90%"></textarea><br><br>
