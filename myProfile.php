...
<head>
    ...
    <title>TwEEttaLk | MyProfile</title>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="icon-bar">
                        ...
                        <a style="color:white; background-color: #000000;" href="myProfile.php"><i class="fa fa-user tabLogo "></i></a>
                ...
                <div id="myProfile" class="mainContainer">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 profileInfo">
                            ...
                            <h5><i class="fa fa-briefcase"></i> Student at TwEEttaLk</h5>
